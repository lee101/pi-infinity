...
2:
  --auto-next-steps              Automatically continue with the next concrete steps
  --auto-next-idea               Ideate and implement improvements after current work
...
${chalk.bold("Examples:")}
  ...
  # Continue autonomously, then generate and implement new improvement ideas
