...
const codingAgentPackageName = JSON.parse(readFileSync(join(codingAgentDir, "package.json"), "utf8")).name;
const installPackageName = `${codingAgentPackageName}-install`;
